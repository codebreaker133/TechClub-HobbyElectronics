...
display = Adafruit_SSD1683(DISPLAY_HIGHT, DISPLAY_WIDTH, SPI, cs_pin=EINK_CHIP_SELECT, dc_pin=EINK_DATACOMMAND, sramcs_pin=SRAM_SELECT, rst_pin=EINK_RST, busy_pin=EINK_BUSY) #creat connection for display with its extra pins
display.rotation = ROTATION
WHITE = Adafruit_EPD.WHITE
BLACK = Adafruit_EPD.BLACK
RED = Adafruit_EPD.RED

text = "hello dumb asses"
x=50
y=25
